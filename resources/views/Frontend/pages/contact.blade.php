...
@section('content')
        ...
        <div class="container-fluid bg-breadcrumb_background">
            <div class="container text-center py-5" style="max-width: 900px;">
                <h4 class="text-white display-4 mb-4 wow fadeInDown text-dark" data-wow-delay="0.1s">Contact Us</h4>
            ...
            <div class="container py-5">
                ...
                <div class="row g-5">
                            ...
                            <div class="row g-4">
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.2s">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Address</h4>
                                            <p class="mb-0">Flat #3A, House #13, Road #13A, Dhanmondi, Dhaka 1209, Bangladesh</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.4s">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Mail Us</h4>
                                            <p class="mb-0">info@bsatbd.com</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.6s">
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            <h4>Telephone</h4>
                                            <p class="mb-0">+880 1774-414035</p>
                                            <p class="mb-0"><b>USA Support:</b></p>
                                            <p class="mb-0">+1 (347) 123-4567 </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.8s">
                                    <div class="contact-add-item">
                                        <div class="contact-icon text-primary mb-4">
                                            <i class="far fa-clock fa-2x"></i> <!-- Clock icon -->
                                        </div>
                                        <div>
                                            <h4>Office Hours</h4>
                                            <p class="mb-0">Saturday - Thursday | 10:00 AM - 6:00 PM</p>
                    ...
                    <div class="col-12 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="rounded">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1825.9084960303032!2d90.37484413880973!3d23.75390464965172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8ad1fd7d513%3A0x8a7a64920e33c9ec!2zMTMg4Ken4KepIOCmqOCmgiDgprDgpr7gprjgp43gpqTgpr4sIOCmouCmvuCmleCmviAxMjA1!5e0!3m2!1sbn!2sbd!4v1750308573400!5m2!1sbn!2sbd" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
                </div>
            </div>
