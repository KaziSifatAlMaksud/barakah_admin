                  ...
                  <div class="footer-item">
                    ...
                    <div class="footer-btn d-flex">
                      <a
                        ...
                        href=" https://www.facebook.com/profile.php?id=61572919227052"
                        ><i class="fab fa-facebook-f"></i
                      ></a>
                      <a
                        class="btn btn-md-square rounded-circle me-3"
                        href=" https://www.instagram.com/bsat.bd/"
                        ><i class="fab fa-instagram"></i
                      ></a>
                      <a
                        class="btn btn-md-square rounded-circle me-0"
                        href="https://www.linkedin.com/company/bsatbd"
          ...
          <div class="col-xl-4">
            <div class="footer-item">
              ...
              <p class="text-white mb-3">
                Stay connected! Get the latest updates, tips, and offers
        ...
        <div class="row g-4 align-items-center">
          <div class="col-md-6 text-center text-md-end mb-md-0">
            <span class="text-body"
              >Copyright &copy; 2025 <b> Barakah Study Abroad & Tours</b>, All
              right reserved.</span
            >
          </div>
        </div>
